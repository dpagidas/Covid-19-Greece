package com.unipi.application.corona.apis.IntensiveCareApi.controller;
...
@Component
public class IntensiveCareApiController {

    @Autowired
    private IntensiveCareApiService intensiveCareApiService;

    public List<IntensiveCare> getIntensiveCare() {
        return intensiveCareApiService.getIntensiveCare();
    }
}
