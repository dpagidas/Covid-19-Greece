package com.unipi.application.corona.apis.ConfirmedCasesApi.service;
...
@Component
public class ConfirmedCasesApiService {
    ...
    public List<ConfirmedCases> getConfirmedCases() {
        ...
        try {
            ...
            try {
                ...
                confirmedCasesList = modelMapper.readValue(documents.toString(), new TypeReference<List<ConfirmedCases>>() {
                });
